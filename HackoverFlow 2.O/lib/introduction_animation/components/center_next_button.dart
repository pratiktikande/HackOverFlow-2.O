...
class CenterNextButton extends StatelessWidget {
          ...
          Padding(
            ...
            child: SlideTransition(
              ...
              child: Center( // Center the button
                child: Container(
                  width: 255, // Match the width of the Sign Up button
                  height: 58,
                  decoration: BoxDecoration(
                  ...
                  child: InkWell(
                    onTap: () {
                      sharedsetter('client');
                      Navigator.pushNamed(context, route.csignup);
                      // Navigator.pushReplacementNamed(context, route.csignup);
                    },
                    child: const Padding(
  ...
  Future<void> sharedsetter(String s) async {
    var sharedpref = await SharedPreferences.getInstance();
    sharedpref.setString("tmp_usr_typ",s);
  }
}
